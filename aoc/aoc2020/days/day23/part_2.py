...
class LinkedListNode:
    def __init__(self, value):
        ...
        self.left: LinkedListNode = None
        self.right: LinkedListNode = None
...
def solve_part_one(cup_labeling: str) -> int:
    labels_raw = extend_labeling(cup_labeling, 1000000)
    ...
    one = label_map[1]
    return one.right.value * one.right.right.value
